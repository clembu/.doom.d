...
* About this document
This is my [[github:hlissner/doom-emacs][doom-emacs]] configuration.
...
Then I discovered [[github:tonsky/FiraCode][Fira Code]], and its ligatures, and I thought:
#+BEGIN_QUOTE
What a great way to read code!
#+END_QUOTE

So I tried my best to include ligatures in my [[github:facelesspanda/.spacemacs.d][spacemacs config of the time]].

When I switched to Doom, I realized it already had Fira support built-in, but
also a font called [[github:be5invis/Iosevka][Iosevka]], which I checked out and liked a lot. So I went and
...
And now I'm using [[github:muirmanders/emacs-nova-theme][Nova (but the doom version)]]:
#+BEGIN_SRC emacs-lisp :tangle yes
